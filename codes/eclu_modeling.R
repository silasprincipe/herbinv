...
writeRaster(cur.full, paste0(out.f, "/proj/GBM_cur_eclu.tif"))
writeRaster(cur.thre, paste0(out.f, "/proj/GBM_cur_eclu_TSS.tif"))
...
for (i in 1:4) {
        ...
        writeRaster(fut.full, paste0(out.f, "/proj/GBM_", ssp, "_eclu.tif"))
        writeRaster(fut.thre, paste0(out.f, "/proj/GBM_", ssp, "_eclu_TSS.tif"))
}
...
# Save model data
save.mod(final.result, out.f, "GBM", "eclu")
...
writeRaster(cur.full, paste0(out.f, "/proj/RF_cur_eclu.tif"))
writeRaster(cur.thre, paste0(out.f, "/proj/RF_cur_eclu_TSS.tif"))
...
for (i in 1:4) {
        ...
        writeRaster(fut.full, paste0(out.f, "/proj/RF_", ssp, "_eclu.tif"))
        writeRaster(fut.thre, paste0(out.f, "/proj/RF_", ssp, "_eclu_TSS.tif"))
}
...
# Save model data
save.mod(final.result, out.f, "RF", "eclu")
...
writeRaster(cur.full, paste0(out.f, "/proj/GAM_cur_eclu.tif"))
writeRaster(cur.thre, paste0(out.f, "/proj/GAM_cur_eclu_TSS.tif"))
...
for (i in 1:4) {
        ...
        writeRaster(fut.full, paste0(out.f, "/proj/GAM_", ssp, "_eclu.tif"))
        writeRaster(fut.thre, paste0(out.f, "/proj/GAM_", ssp, "_eclu_TSS.tif"))
}
...
# Save model data
save.mod(final.result, out.f, "GAM", "eclu")
...
glm.formula <- dsp ~ BO_ph + I(BO_ph^2) + BO21_chlomean_ss + BO21_silicatemean_ss + 
               I(BO21_tempmean_ss^2)
...
writeRaster(cur.full, paste0(out.f, "/proj/GLM_cur_eclu.tif"))
writeRaster(cur.thre, paste0(out.f, "/proj/GLM_cur_eclu_TSS.tif"))
...
for (i in 1:4) {
        ...
        writeRaster(fut.full, paste0(out.f, "/proj/GLM_", ssp, "_eclu.tif"))
        writeRaster(fut.thre, paste0(out.f, "/proj/GLM_", ssp, "_eclu_TSS.tif"))
}
...
# Save model data
save.mod(final.result, out.f, "GLM", "eclu")
...
### END of eclu modeling
write(paste("Modeling procedure concluded at:", date()),
      file = paste0(out.f, "/eclu_log_file.txt"), append = T)
