...
writeRaster(cur.full, paste0(out.f, "/proj/GBM_cur_lyva.tif"))
writeRaster(cur.thre, paste0(out.f, "/proj/GBM_cur_lyva_TSS.tif"))
...
for (i in 1:4) {
        ...
        writeRaster(fut.full, paste0(out.f, "/proj/GBM_", ssp, "_lyva.tif"))
        writeRaster(fut.thre, paste0(out.f, "/proj/GBM_", ssp, "_lyva_TSS.tif"))
}
...
# Save model data
save.mod(final.result, out.f, "GBM", "lyva")
...
writeRaster(cur.full, paste0(out.f, "/proj/RF_cur_lyva.tif"))
writeRaster(cur.thre, paste0(out.f, "/proj/RF_cur_lyva_TSS.tif"))
...
for (i in 1:4) {
        ...
        writeRaster(fut.full, paste0(out.f, "/proj/RF_", ssp, "_lyva.tif"))
        writeRaster(fut.thre, paste0(out.f, "/proj/RF_", ssp, "_lyva_TSS.tif"))
}
...
# Save model data
save.mod(final.result, out.f, "RF", "lyva")
...
writeRaster(cur.full, paste0(out.f, "/proj/GAM_cur_lyva.tif"))
writeRaster(cur.thre, paste0(out.f, "/proj/GAM_cur_lyva_TSS.tif"))
...
for (i in 1:4) {
        ...
        writeRaster(fut.full, paste0(out.f, "/proj/GAM_", ssp, "_lyva.tif"))
        writeRaster(fut.thre, paste0(out.f, "/proj/GAM_", ssp, "_lyva_TSS.tif"))
}
...
# Save model data
save.mod(final.result, out.f, "GAM", "lyva")
...
glm.formula <- dsp ~ BO21_lightbotmax_bdmean + BO_ph + I(BO_ph^2) + 
        BO21_silicatemean_ss + I(BO21_silicatemean_ss^2) + BO21_salinitymean_ss + 
        BO21_tempmean_ss + I(BO21_tempmean_ss^2)
...
writeRaster(cur.full, paste0(out.f, "/proj/GLM_cur_lyva.tif"))
writeRaster(cur.thre, paste0(out.f, "/proj/GLM_cur_lyva_TSS.tif"))
...
for (i in 1:4) {
        ...
        writeRaster(fut.full, paste0(out.f, "/proj/GLM_", ssp, "_lyva.tif"))
        writeRaster(fut.thre, paste0(out.f, "/proj/GLM_", ssp, "_lyva_TSS.tif"))
}
...
# Save model data
save.mod(final.result, out.f, "GLM", "lyva")
...
### END of lyva modeling
write(paste("Modeling procedure concluded at:", date()),
      file = paste0(out.f, "/lyva_log_file.txt"), append = T)
