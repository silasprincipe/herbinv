...
# Load threshold data ----
thresholds <- readRDS("data/oisst/allspecies_oisst_thvalues.rds")
...
for (i in 1:length(species)){
    ...
    curr <- raster(paste0("data/oisst/frequency_", species[i],"_thresh.tif"))
    fut <- raster(paste0("data/oisst/frequency_", species[i],"_thresh_fut.tif"))
    ...
    # Convert frequency rasters to percentage
    curr <- curr / 4018
    fut <- fut / 4018
