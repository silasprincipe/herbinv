...
curr.q1 <- raster(paste0("results/", sp, "/predictions/", sp, "_q0.025_m", m, "_", type,"_current.tif"))
ssp1.q1 <- raster(paste0("results/", sp, "/predictions/", sp, "_q0.025_m", m, "_", type,"_ssp1.tif"))
ssp2.q1 <- raster(paste0("results/", sp, "/predictions/", sp, "_q0.025_m", m, "_", type,"_ssp2.tif"))
ssp3.q1 <- raster(paste0("results/", sp, "/predictions/", sp, "_q0.025_m", m, "_", type,"_ssp3.tif"))

curr.q2 <- raster(paste0("results/", sp, "/predictions/", sp, "_q0.975_m", m, "_", type,"_current.tif"))
ssp1.q2 <- raster(paste0("results/", sp, "/predictions/", sp, "_q0.975_m", m, "_", type,"_ssp1.tif"))
ssp2.q2 <- raster(paste0("results/", sp, "/predictions/", sp, "_q0.975_m", m, "_", type,"_ssp2.tif"))
ssp3.q2 <- raster(paste0("results/", sp, "/predictions/", sp, "_q0.975_m", m, "_", type,"_ssp3.tif"))

curr.sd <- raster(paste0("results/", sp, "/predictions/", sp, "_sd_m", m, "_", type,"_current.tif"))
ssp1.sd <- raster(paste0("results/", sp, "/predictions/", sp, "_sd_m", m, "_", type,"_ssp1.tif"))
ssp2.sd <- raster(paste0("results/", sp, "/predictions/", sp, "_sd_m", m, "_", type,"_ssp2.tif"))
ssp3.sd <- raster(paste0("results/", sp, "/predictions/", sp, "_sd_m", m, "_", type,"_ssp3.tif"))
...
curr.v <- get.val(curr.q1)
ssp1.v <- get.val(ssp1.q1)
ssp2.v <- get.val(ssp2.q1)
ssp3.v <- get.val(ssp3.q1)
...
step.guide_b <- guide_colorbar(title = "Standard deviation",
                             show.limits = TRUE,
                             barheight = unit(0.12, "in"),
                             barwidth = unit(3.5, "in"),
                             ticks = F,
...
sca <- scale_fill_gradientn(
        ...
        limits = c(0,
                   max(c(
                           maxValue(curr.q1), maxValue(curr.q2),
                           maxValue(ssp1.q1), maxValue(ssp1.q2),
                           maxValue(ssp2.q1), maxValue(ssp2.q2),
                           maxValue(ssp3.q1), maxValue(ssp3.q2)
                   ))),
        guide = step.guide,
        #labels = c("Low", "", "", "", "High"),
        na.value = "#381900")
...
sca_b <- scale_fill_distiller(palette = "BuPu", guide = step.guide_b,
                              limits = c(0,
                                         max(c(
                                                 maxValue(curr.sd),
                                                 maxValue(ssp1.sd),
...
curr.v <- get.val(curr.q2)
ssp1.v <- get.val(ssp1.q2)
ssp2.v <- get.val(ssp2.q2)
ssp3.v <- get.val(ssp3.q2)
...
final2 <- pcf + ps1f + ps2f + ps3f + plot_layout(nrow = 1, guides = "collect") &
...
curr.v <- get.val(curr.sd)
ssp1.v <- get.val(ssp1.sd)
ssp2.v <- get.val(ssp2.sd)
ssp3.v <- get.val(ssp3.sd)
...
(pc <- ggplot()+
                ...
                #            aes(x = (x2 - 100), y = (y2 - 100), label = label))+
                # Add title
                geom_label(aes(label = "I", x = 4000, y = 4100),
                           size = 10, fontface = "bold", color = "grey30",
                           label.size = 0)+
                # Remove axis labels and add theme
                xlab("") + ylab("") + wlt +
...
(ps1 <- ggplot()+
         ...
         #            aes(x = (x2 - 100), y = (y2 - 100), label = label))+
         # Add title
         geom_label(aes(label = "J", x = 4000, y = 4100),
                    size = 10, fontface = "bold", color = "grey30",
                    label.size = 0)+
         # Remove axis labels and add theme
         xlab(NULL) + ylab(NULL) + wlt +
...
(ps2 <- ggplot()+
         ...
         #            aes(x = (x2 - 100), y = (y2 - 100), label = label))+
         # Add title
         geom_label(aes(label = "K", x = 4000, y = 4100),
                    size = 10, fontface = "bold", color = "grey30",
                    label.size = 0)+
         # Remove axis labels and add theme
         xlab(NULL) + ylab(NULL) + wlt +
...
(ps3 <- ggplot()+
         ...
         #            aes(x = (x2 - 100), y = (y2 - 100), label = label))+
         # Add title
         geom_label(aes(label = "L", x = 4000, y = 4100),
                    size = 10, fontface = "bold", color = "grey30",
                    label.size = 0)+
         # Remove axis labels and add theme
         xlab(NULL) + ylab(NULL) + wlt +
...
final3 <- pcf + ps1f + ps2f + ps3f + plot_layout(nrow = 1, guides = "collect") &
        theme(legend.position='bottom')



final.tot <- final / final2 / final3


ggsave(paste0("figures/", sp, "_lgcp_supp_comp_m", m, "_", type, "_quantiles.jpg"),
       final.tot,
       width = 50, height = 54, units = "cm", quality = 100)
